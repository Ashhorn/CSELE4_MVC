...
namespace CSELE4_MVC.Controllers
{
    public class ProductsController : Controller
    {
        private readonly CSELE4_MVCContext _context;
        private readonly IFormFileService _formFileService;

        public ProductsController(CSELE4_MVCContext context, IFormFileService formFileService)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Category,Price,Content")] Products products)
        {
            if (id != products.Id)
            {
                return NotFound();
